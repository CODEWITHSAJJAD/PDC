...
namespace DeadLockDemo
{
    class MainClass
    {
        public static void Main(string[] args)
        {
            ...
            Thread thread1 = new Thread(() => accountManager1.FundTransferInfiniteAttempt()) { Name = "Thread-A" };
    ...
    public class AccountManager
    {
        ...
        public void FundTransferWithFewAttempts()
        {
            ...
            int retryCount = 0;
            TimeSpan retryDelay = TimeSpan.FromMilliseconds(100); // Delay between retries
